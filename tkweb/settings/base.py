...
CONSTANCE_CONFIG = {
    ...
    "ICAL_URL": (
        "https://www.google.com/calendar/ical/best@taagekammeret.dk/public/basic.ics",
        "iCalendar URLen hvor den offentlige kalender bliver genereret fra.",
    ),
    "CAL_URL": (
        "//calendar.google.com/calendar/embed?src=BEST@TAAGEKAMMERET.dk&ctz=Europe/Copenhagen",
