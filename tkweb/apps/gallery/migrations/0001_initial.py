    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=tkweb.apps.gallery.models.get_gfyear
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    versatileimagefield.fields.VersatileImageField(
                        upload_to=tkweb.apps.gallery.models.file_name
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="gallery.Album", related_name="basemedia", on_delete=models.CASCADE
            ),
        ),
        migrations.AlterUniqueTogether(
            name="album", unique_together=set([("gfyear", "slug")])
        ),
        migrations.AlterUniqueTogether(
            name="basemedia", unique_together=set([("album", "slug")])
        ),
    ]
