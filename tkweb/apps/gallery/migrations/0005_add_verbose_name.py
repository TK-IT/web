...
import tkweb.apps.gallery.utils
import datetime


class Migration(migrations.Migration):

    dependencies = [("gallery", "0004_cleanAlbums")]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                verbose_name="Overskrift", blank=True, max_length=200
            ),
        ),
        migrations.AlterField(
            model_name="basemedia",
        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                default=tkweb.apps.gallery.utils.get_gfyear, verbose_name="Årgang"
            ),
        ),
        migrations.AlterField(
            model_name="album",
