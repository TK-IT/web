...
def add_mailing_list_group(apps, schema_editor):
    ...
    relations = [
        Profile.groups.through(group_id=g.id, profile_id=i)
...
class Migration(migrations.Migration):
    ...
    dependencies = [("idm", "0023_rename_fields")]

    operations = [
        migrations.RunPython(add_mailing_list_group, lambda apps, schema_editor: None)
    ]
