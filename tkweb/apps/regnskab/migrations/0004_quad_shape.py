...
def set_shapes(qs, from_shape, to_shape):
    for o in qs:
        ...
        if shape is None:
            print("Object %s: %s has unrecognizable shape" % (o.pk, o.quad))
...
class Migration(migrations.Migration):
    ...
    dependencies = [("regnskab", "0003_sheetimage_parameters")]

    operations = [migrations.RunPython(quad_shape, quad_shape_reverse)]
