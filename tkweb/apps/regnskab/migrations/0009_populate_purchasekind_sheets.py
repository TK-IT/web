...
def populate_purchasekind_sheets(apps, schema_editor):
    ...
    create = [
        PurchaseKind.sheets.through(
            purchasekind_id=kind_id, sheet_id=sheet_id)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('regnskab', '0008_purchasekind_sheets'),
    ]

    operations = [
        migrations.RunPython(populate_purchasekind_sheets),
    ]
