...
urlpatterns = [
    ...
    url(r'^session/(?P<pk>\d+)\.tex$', BalancePrint.as_view(),
        name='balance_print_tex', kwargs=dict(ext='tex')),
    url(r'^session/(?P<pk>\d+)\.pdf$', BalancePrint.as_view(),
        name='balance_print_pdf', kwargs=dict(ext='pdf')),
